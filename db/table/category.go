...
func newCategoryTableImpl(schemaName, tableName, alias string) categoryTable {
	var (
		...
		ParentColumn      = sqlite.IntegerColumn("parent")
		allColumns        = sqlite.ColumnList{IDColumn, NameColumn, DescriptionColumn, ParentColumn}
		mutableColumns    = sqlite.ColumnList{NameColumn, DescriptionColumn, ParentColumn}
	)
